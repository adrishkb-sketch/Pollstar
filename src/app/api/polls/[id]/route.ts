...
export async function GET(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    let creatorPlanObj = poll.creator?.plan;
    let modifiedCreator = poll.creator;
    if (creatorPlanObj && creatorPlanObj.name.toLowerCase() !== 'free' && !creatorPlanObj.isFree) {
